    ...
    return (
        <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
            ...
            <div className="h-full overflow-scroll lg:flex">
                {/* TEXT CONTAINER */}
                <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 text-xl flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:pr-0 w-2/3 xl-1/2">
                    {/* BIOGRAPHY */}
                    ...
                    <div className="flex flex-col gap-12 justify-center">
                        {/* SKILLS TITLE */}
                        <h1 className="font-bold text-2xl">KÉSZSÉGEK</h1>
                        {/* SKILLS LIST */}
                        <div className="flex gap-4 flex-wrap">
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">KÉSZSÉG1</div>
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">KÉSZSÉG2</div>
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">KÉSZSÉG3</div>
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">KÉSZSÉG4</div>
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">KÉSZSÉG5</div>
                            <div className="rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">KÉSZSÉG6</div>
